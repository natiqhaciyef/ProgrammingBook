...
public class MainActivity extends AppCompatActivity {
    ...
    static ArrayList<ProgramFeature> programsArrayList ;
    ...
    public void getData (){
        try{
            SQLiteDatabase sqLiteDatabase = this.openOrCreateDatabase("ProgramFeature",MODE_PRIVATE,null);
            ...
            while (cursor.moveToNext()){
                ...
                ProgramFeature program = new ProgramFeature(id , name);
